...
// Re-export Project from models to use the SPA version with responses
...
export type SectionAFormFields = {
  section_a_1: boolean | null
  section_a_2: boolean | null
  section_a_3: boolean | null
...
export type AnyFormFields =
  | IntroFormFields
  | SectionAFormFields
  | SectionBFormFields
  | SectionCFormFields

export type AllFormFields = IntroFormFields &
  SectionAFormFields &
  SectionBFormFields &
  SectionCFormFields
